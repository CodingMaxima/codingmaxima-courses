...
@Component({
  selector: 'app-loopquestion8',
  templateUrl: './loopquestion8.component.html',
  styleUrls: ['./loopquestion8.component.scss']
})
export class Loopquestion8Component implements OnInit{
  elementId: string;
  audioData: any;
  videoData: any;
