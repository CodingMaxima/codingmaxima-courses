...
@Component({
  selector: 'app-loopquestion4',
  templateUrl: './loopquestion4.component.html',
  styleUrls: ['./loopquestion4.component.scss']
})
export class Loopquestion4Component implements OnInit{
  elementId: string;
  audioData: any;
  videoData: any;
