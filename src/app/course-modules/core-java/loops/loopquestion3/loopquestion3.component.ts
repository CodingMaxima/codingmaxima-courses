...
@Component({
  selector: 'app-loopquestion3',
  templateUrl: './loopquestion3.component.html',
  styleUrls: ['./loopquestion3.component.scss']
})
export class Loopquestion3Component implements OnInit{
  elementId: string;
  audioData: any;
  videoData: any;
