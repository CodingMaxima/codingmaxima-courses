...
@Component({
  selector: 'app-loopquestion2',
  templateUrl: './loopquestion2.component.html',
  styleUrls: ['./loopquestion2.component.scss']
})
export class Loopquestion2Component implements OnInit{
  elementId: string;
  audioData: any;
  videoData: any;
