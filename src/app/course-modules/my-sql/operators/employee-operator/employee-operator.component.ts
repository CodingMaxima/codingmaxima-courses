...
@Component({
  selector: 'app-employee-operator',
  templateUrl: './employee-operator.component.html',
  styleUrls: ['./employee-operator.component.scss']
})
export class EmployeeOperatorComponent implements OnInit {
  toggleOn = false;
  ...
  constructor(mediamap:MediaMySqlMapData) {
    ...
    this.audioData = mediamap.mediaData.Operators.Employee_Operators.audio;
    this.videoData = mediamap.mediaData.Operators.Employee_Operators.video;
  }
