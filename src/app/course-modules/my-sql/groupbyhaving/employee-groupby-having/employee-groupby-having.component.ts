...
@Component({
  selector: 'app-employee-groupby-having',
  templateUrl: './employee-groupby-having.component.html',
  styleUrls: ['./employee-groupby-having.component.scss']
})
export class EmployeeGroupbyHavingComponent implements OnInit {
...
"Walking Tree Technologies,1"
  ...
  constructor(mediamap:MediaMySqlMapData) {
    ...
    this.audioData = mediamap.mediaData.GroupBy_Having.Employee_groupby_having.audio;
    this.videoData = mediamap.mediaData.GroupBy_Having.Employee_groupby_having.video;
